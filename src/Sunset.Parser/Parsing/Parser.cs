...
public partial class Parser
{
    ...
    /// </summary>
    /// <param name="source"><inheritdoc cref="Parser(ReadOnlyMemory, bool)"/></param>
    /// <param name="parse"><inheritdoc cref="Parser(Lexer, bool)" /></param>
    ...
    /// </summary>
    /// <param name="type"><inheritdoc cref="Consume" /></param>
    /// <returns><inheritdoc cref="Consume"/></returns>
