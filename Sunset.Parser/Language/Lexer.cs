...
public class Lexer
{
    ...
    {
        _position++;
        // TODO: Investigate whether storing this character is requiring inefficient memory access
    ...
    /// </summary>
    public void Scan(bool ignoreWhitespace = true)
    {
        Reset();
    ...
    private IToken GetIdentifierSymbolToken()
    {
        var start = _position;
        var columnStart = _column;
        // Assume that first character is an @
        Advance();
